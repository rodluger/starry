...
with open(".animation.tex", "w") as f:
    print(r"\newcommand{\animation}[1]{\marginnote{\href{https://github.com/rodluger/starry/blob/%s/tex/figures/#1.gif}{\color{linkcolor}\Large\faPlayCircleO}}}" % hash, file=f)
with open(".figanimation.tex", "w") as f:
    print(r"\newcommand{\figanimation}[1]{\marginnote{\hspace{1.75em}\href{https://github.com/rodluger/starry/blob/%s/tex/figures/#1.gif}{\color{linkcolor}\Large\faPlayCircleO}}}" % hash, file=f)
