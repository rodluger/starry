    ...
    */
    ...
    public:
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2);
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i));
            return res;
        }
    ...
    */
    ...
    public:
        ...
        T operator()(const Scalar<T>& arg1, const Scalar<T>& arg2, const T& arg3) {
            T res(arg3.size());
            for (long i = 0; i < arg3.size(); i++) res(i) = function(arg1, arg2, arg3(i));
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const Scalar<T>& arg3) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3);
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const T& arg3) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2, const Scalar<T>& arg3) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2, arg3);
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2, const T& arg3) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2, arg3(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const Scalar<T>& arg3) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3);
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const T& arg3) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3(i));
            return res;
        }
    ...
    */
    ...
    public:
        ...
        T operator()(const Scalar<T>& arg1, const Scalar<T>& arg2, const Scalar<T>& arg3, const T& arg4) {
            T res(arg4.size());
            for (long i = 0; i < arg4.size(); i++) res(i) = function(arg1, arg2, arg3, arg4(i));
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const Scalar<T>& arg2, const T& arg3, const Scalar<T>& arg4) {
            T res(arg3.size());
            for (long i = 0; i < arg3.size(); i++) res(i) = function(arg1, arg2, arg3(i), arg4);
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const Scalar<T>& arg2, const T& arg3, const T& arg4) {
            T res(arg3.size());
            for (long i = 0; i < arg3.size(); i++) res(i) = function(arg1, arg2, arg3(i), arg4(i));
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const Scalar<T>& arg3, const Scalar<T>& arg4) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3, arg4);
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const Scalar<T>& arg3, const T& arg4) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3, arg4(i));
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const T& arg3, const Scalar<T>& arg4) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3(i), arg4);
            return res;
        }
        ...
        T operator()(const Scalar<T>& arg1, const T& arg2, const T& arg3, const T& arg4) {
            T res(arg2.size());
            for (long i = 0; i < arg2.size(); i++) res(i) = function(arg1, arg2(i), arg3(i), arg4(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2, const Scalar<T>& arg3, const T& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2, arg3, arg4(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2, const T& arg3, const Scalar<T>& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2, arg3(i), arg4);
            return res;
        }
        ...
        T operator()(const T& arg1, const Scalar<T>& arg2, const T& arg3, const T& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2, arg3(i), arg4(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const Scalar<T>& arg3, const Scalar<T>& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3, arg4);
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const Scalar<T>& arg3, const T& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3, arg4(i));
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const T& arg3, const Scalar<T>& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3(i), arg4);
            return res;
        }
        ...
        T operator()(const T& arg1, const T& arg2, const T& arg3, const T& arg4) {
            T res(arg1.size());
            for (long i = 0; i < arg1.size(); i++) res(i) = function(arg1(i), arg2(i), arg3(i), arg4(i));
            return res;
        }
