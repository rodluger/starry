...
modules = dict(
    ...
    _STARRY_DEFAULT_LIMBDARKENED_DOUBLE_=2,
    _STARRY_SPECTRAL_DOUBLE_=4,
    _STARRY_SPECTRAL_LIMBDARKENED_DOUBLE_=8,
    ...
    _STARRY_DEFAULT_MULTI_=256,
    _STARRY_DEFAULT_LIMBDARKENED_MULTI_=512,
    _STARRY_SPECTRAL_MULTI_=1024,
    _STARRY_SPECTRAL_LIMBDARKENED_MULTI_=2048,
    _STARRY_TEMPORAL_MULTI_=4096,
