...
class build_ext(_build_ext):
    ...
    def build_extensions(self):
        # The include directory for the headers
        localincl = os.path.join("starry", "cpp")
        if not os.path.exists(os.path.join(localincl, "starry.h")):
            raise RuntimeError("couldn't find starry headers")
